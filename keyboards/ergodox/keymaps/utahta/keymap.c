 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | LCtrl| LAlt |      | LCnd | RCmd |                                       | Left | Down |  Up  | Right|   L1 |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | LAlt | L3   |       | Left | Right  |
 *                                 ,------|------|------|       |------+--------+------.
 ...
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  |   \    |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | LCtrl| LAlt |      | ZKHK | LCtrl|                                       | Left | Down |  Up  | Right|   L1 |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | LAlt | TGL  |       | Left | Right  |
 *                                 ,------|------|------|       |------+--------+------.
...
[WINS] = KEYMAP(  // layer 0 : default
        ...
        KC_LCTRL, KC_LALT, KC_NO, KC_ZKHK, KC_LCTRL,
                                                             KC_LALT, KC_TRNS,
                                                                      KC_HOME,
                                                     KC_SPC, KC_LSFT, KC_END,
        // right hand
...
const uint16_t PROGMEM fn_actions[] = {
    [1] = ACTION_LAYER_TAP_TOGGLE(FNCK)                // FN1 - Momentary Layer 1 (Function key)
};
